...
int main()
{
    ...
    {
        SRC_PATH + (std::string)"skybox/right.jpg",
        SRC_PATH + (std::string)"skybox/left.jpg",
        SRC_PATH + (std::string)"skybox/top.jpg",
        SRC_PATH + (std::string)"skybox/bottom.jpg",
        SRC_PATH + (std::string)"skybox/front.jpg",
        SRC_PATH + (std::string)"skybox/back.jpg"
    };
