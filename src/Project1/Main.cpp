...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
		...
		// render the next life every interval
        nextLife();
...
int main()
{
    ...
    // build and compile our shader program
    // ------------------------------------
    Shader ourShader("C:/Users/HOI3/source/repos/G4G_Basic/src/Project1/shader.vert", "C:/Users/HOI3/source/repos/G4G_Basic/src/Project1/shader.frag"); // you can name your shader files however you like
