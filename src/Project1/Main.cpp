...
int main()
{
	...
	// skybox shader
    Shader skyboxShader((SRC_PATH2 + (std::string)"skybox.vert").c_str(),
        (SRC_PATH2 + (std::string)"skybox.frag").c_str());
    ...
    //Model ourModel((SRC_PATH2 + (std::string)"backpack/backpack.obj").c_str());
    ...
    {
        SRC_PATH2 + (std::string)"night-sky-cube-map/right.png",
        SRC_PATH2 + (std::string)"night-sky-cube-map/left.png",
        SRC_PATH2 + (std::string)"night-sky-cube-map/top.png",
        SRC_PATH2 + (std::string)"night-sky-cube-map/bottom.png",
        SRC_PATH2 + (std::string)"night-sky-cube-map/front.png",
        SRC_PATH2 + (std::string)"night-sky-cube-map/back.png"
    };
    unsigned int cubemapTexture = loadCubemap(faces);

    unsigned int diffuseMap = loadTexture((SRC_PATH2 + (std::string)"container2.png").c_str());
    unsigned int specularMap = loadTexture((SRC_PATH2 + (std::string)"container2_specular.png").c_str());
...
int main()
{
    ...
    // build and compile our shader program
    // ------------------------------------
    Shader ourShader(SRC_PATH2 + "shader.vert", SRC_PATH2 + "shader.frag"); // you can name your shader files however you like
...
int main()
{
    ...
    // ------------------------------------
    Shader ourShader((SRC_PATH2 + (std::string)"src/Project1/coordinate_systems.vert").c_str(), (SRC_PATH2 + (std::string)"src/Project1/coordinate_systems.frag").c_str());
    ...
    unsigned char* data = stbi_load((SRC_PATH2 + (std::string)"tools/hoi3@rpi.edu.png").c_str(), &width, &height, &nrChannels, 0);
    if (data)
    {
...
int main()
{
    ...
    // build and compile our shader zprogram
    // ------------------------------------
    Shader lightingShader((SRC_PATH2 + (std::string)"lighting.vert").c_str(), 
        (SRC_PATH2 + (std::string)"lighting.frag").c_str());
    Shader lightCubeShader((SRC_PATH2 + (std::string)"lighting.vert").c_str(),
        (SRC_PATH2 + (std::string)"lighting2.frag").c_str());
...
int main()
{
    ...
    // -----------------------------------------------------------------------------
    unsigned int diffuseMap = loadTexture((SRC_PATH2 + (std::string)"hoi3@rpi.edu.png").c_str());
    unsigned int specularMap = loadTexture((SRC_PATH2 + (std::string)"container2_specular.png").c_str());
